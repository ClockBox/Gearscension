...
public class GroundedState : PlayerState
{
    ...
    public override void UpdateIK()
    {
        ...
        if (Physics.Raycast(RightFoot.position + Player.transform.up * 0.1f, -Player.transform.up, out RightHit, 0.5f,IgnoreMechanics))
        {
        ...
        if (Physics.Raycast(LeftFoot.position + Player.transform.up * 0.1f, -Player.transform.up, out LeftHit, 0.5f, IgnoreMechanics))
        {
